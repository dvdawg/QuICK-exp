"""Rabi chevron: drive frequency versus pulse gain at fixed duration."""
...
Q_FREQUENCY_MHZ = np.arange(5590.0, 5610.0, 0.25)
Q_GAIN = np.linspace(0.02, 0.80, 80)
Q_LENGTH_US = 0.1
EXTRA_PI_PULSES = 0
R_POWER_DB = -30.0
R_LENGTH_US = 2.0
...
def main():
    ...
    return run_experiment(
        ...
        preset="rabi_chevron_amplitude",
        title=f"RabiChevronAmplitude_{z_tag(Z_GAIN)}_r{number_tag(readout_frequency_mhz)}_q{number_tag(Q_FREQUENCY_MHZ)}",
